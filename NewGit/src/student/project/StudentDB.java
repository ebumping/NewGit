...
public class StudentDB{
	...
	public void modAssignment(String assignmentName, String newAssignmentName){
		for(String x : students){
			...
			//allows assignments in assignment map to be modified and does so for each student
		}
	}
	...
	public void grade(String student, String hw, int grade){
		...
		//this method will input a grade for the specified assignment of the specified student
			}
	...
	public static void main(String[] arg){		
		...
		//db.createAssignment(new Student("Nova") );
